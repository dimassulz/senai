/*
 * FUNCOES PUBLICAS (VISIVEIS A TODOS OS SCRIPTS)
 * Essa função AJAX retorna o arquivo html da pasta paginas
 */
carregaPagina = function carregaPagina(nomePagina) {
    $.ajax({
...
carregarPaginasGeral = function carregarPaginasGeral(obj) {
     ...
     */
    var nomePag = obj.attr('href').replace('#', '') + '.html';
